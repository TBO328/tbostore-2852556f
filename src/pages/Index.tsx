...
import { ArrowRight, Shield, Zap, Headphones, ChevronDown, Gamepad2, CreditCard, Paintbrush, Gift } from 'lucide-react';
      ...
      <main>
        ...
        <section className="relative min-h-[100svh] overflow-hidden flex items-center justify-start">
          ...
          <motion.div
            ...
            <img src={heroBgPattern} alt="" className="w-full h-full object-cover opacity-40" />
