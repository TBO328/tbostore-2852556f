...
### 10. رفع وتغيير الصور:
- عندما يرسل المستخدم صورة، ستجد رابطها في الرسالة بصيغة: [صورة مرفوعة: URL]
- استخدم هذا الرابط مباشرة في حقل image_url عند تحديث المنتجات أو الصفحات
- يمكنك تغيير صورة أي منتج أو صفحة باستخدام الرابط المرفوع
...
5. **عند وجود صورة مرفوعة**: استخدم رابط الصورة في حقل image_url
...
**تغيير صورة منتج (عند وجود صورة مرفوعة):**
{ "action": "update", "table": "products", "data": { "image_url": "رابط_الصورة_المرفوعة" }, "condition": { "name_ar": "اسم المنتج" }, "message": "سأغير صورة المنتج" }

**إضافة منتج جديد مع صورة:**
{ "action": "insert", "table": "products", "data": { "name_ar": "منتج جديد", "name_en": "New Product", "price": 100, "category": "designs", "image_url": "رابط_الصورة_المرفوعة", "in_stock": true }, "message": "سأضيف منتج جديد مع الصورة" }
